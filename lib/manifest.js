...
(function () {
  ...
  var ENVIO = {
    zonas: {
      /* PRUEBA TEMPORAL: precio en 5 en vez de 0/gratis para probar el
         flujo de envío pago. Volver a precio:0, gratis:true apenas
         termine la prueba. */
      'san-luis':  { nombre: 'San Luis (zona local)', precio: 5,     disponible: true, gratis: false },
  ...
  var PRODUCTOS = [
    ...
    /* PRUEBA TEMPORAL — sacar este producto apenas termine la prueba de
       Mercado Pago/envío/mail. No es un producto real. */
    { id:'prueba-no-comprar',      nombre:'PRUEBA — no comprar',        cat:'discontinuos', sub:'liquidacion', talles:'Único', colores:['Prueba'], precio:10, precioAntes:0, img:'assets/img/baberos.webp', destacado:false, guiaTalles:'babero' }
  ...
  var FAQS = [
    ...
    { q: '¿Cómo puedo pagar?',
      a: 'Efectivo, débito, crédito en 3 cuotas sin interés, transferencia y QR.' },
    { q: '¿Cómo compro?',
